...
<template>
  <!-- 右上角 GitHub 角标：官方 octicon「mark-github」圆形小猫，点一下跳到作者 GitHub 主页。
       定位是 fixed，滚动时一直贴在视口右上角；主题切换按钮在左上角，两者不抢位置。 -->
  <a
    class="gh-corner"
    :href="COMMUNITY.profileUrl"
    target="_blank"
    rel="noopener noreferrer"
    :aria-label="`在新标签页打开 ${COMMUNITY.owner} 的 GitHub 主页`"
    :title="COMMUNITY.profileUrl"
  >
    <!-- 图标来自 primer/octicons 的 mark-github-24.svg，纯装饰，无障碍文案交给外层链接 -->
